  ...
  switch (normalized) {
    ...
    case 'ts':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          ...
          <path
            d="M11.5 8.5H5.5V10h2.1v7h1.8v-7h2.1V8.5zm2.8 5.7c.4.6 1.1 1 2 1 .9 0 1.5-.4 1.5-1 0-.6-.5-.9-1.4-1.2l-.7-.3c-1.4-.5-2.2-1.2-2.2-2.4 0-1.5 1.2-2.6 2.9-2.6 1.3 0 2.2.4 2.8 1.4l-1.3.9c-.3-.5-.7-.8-1.5-.8-.7 0-1.2.4-1.2.9 0 .5.4.8 1.2 1.1l.7.3c1.6.6 2.4 1.3 2.4 2.6 0 1.6-1.3 2.7-3.2 2.7-1.5 0-2.6-.6-3.3-1.7l1.3-.9z"
            fill="#FFFFFF"
          />
        </svg>
      );
    ...
    case 'js':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          ...
          <path
            d="M6.5 17.5c1 .6 2 .9 3 .9 1.6 0 2.6-.8 2.6-2.4V8.5h-2v7.4c0 .6-.4.9-1 .9-.4 0-.8-.1-1.3-.3l-1.3 1zm7.8-3.2c.4.6 1.1 1 2 1 .9 0 1.5-.4 1.5-1 0-.6-.5-.9-1.4-1.2l-.7-.3c-1.4-.5-2.2-1.2-2.2-2.4 0-1.5 1.2-2.6 2.9-2.6 1.3 0 2.2.4 2.8 1.4l-1.3.9c-.3-.5-.7-.8-1.5-.8-.7 0-1.2.4-1.2.9 0 .5.4.8 1.2 1.1l.7.3c1.6.6 2.4 1.3 2.4 2.6 0 1.6-1.3 2.7-3.2 2.7-1.5 0-2.6-.6-3.3-1.7l1.3-.9z"
            fill="#000000"
          />
        </svg>
      );
    ...
    case 'rxjs':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          <path
            d="M21.5 7.6c-.2-.6-.6-1.1-1.2-1.4L13.1 2.4c-.7-.4-1.5-.4-2.2 0L3.7 6.2C3.1 6.5 2.7 7 2.5 7.6c-.2.6-.2 1.3 0 1.9l2.8 7.3c.3.7.8 1.2 1.5 1.5l6.3 3.3c.7.4 1.5.4 2.2 0l6.3-3.3c.7-.3 1.2-.8 1.5-1.5l2.8-7.3c.2-.6.2-1.3 0-1.9z"
            fill="#C2185B"
          />
          <path
            d="M20.2 8.3L17.8 15c-.2.5-.5.9-1 1.1l-4.8 2.5-4.8-2.5c-.5-.2-.8-.6-1-1.1L3.8 8.3c-.1-.4 0-.8.2-1.1.2-.3.5-.5.9-.6l5.7-2.9c.4-.2.9-.2 1.3 0l5.7 2.9c.4.1.7.3.9.6.2.3.3.7.2 1.1z"
            fill="#E91E63"
          />
          <path
            d="M12 5.5l-4.5 2.3 2 5.2 2.5 1.3 2.5-1.3 2-5.2L12 5.5z"
            fill="#F06292"
          />
          <circle cx="12" cy="11.5" r="2" fill="#FFFFFF" />
          <path
            d="M12 7.5a4 4 0 00-4 4h1.5a2.5 2.5 0 012.5-2.5V7.5z"
            fill="#FFFFFF"
          />
        </svg>
      );
    ...
    case 'responsive':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <rect x="2" y="3" width="20" height="14" rx="2" stroke="#38BDF8" />
          <line x1="8" y1="21" x2="16" y2="21" stroke="#38BDF8" strokeLinecap="round" />
          <line x1="12" y1="17" x2="12" y2="21" stroke="#38BDF8" strokeLinecap="round" />
        </svg>
      );
    ...
    case 'git':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          <path
            d="M23.546 10.93L13.067.452a1.488 1.488 0 0 0-2.106 0L8.85 2.564l2.673 2.673a1.764 1.764 0 0 1 1.777.419c.53.53.67 1.288.423 1.94l2.607 2.607a1.767 1.767 0 0 1 1.94.423 1.78 1.78 0 0 1 0 2.518 1.78 1.78 0 0 1-2.518 0 1.772 1.772 0 0 1-.416-1.928l-2.43-2.43v5.823a1.773 1.773 0 0 1 .497.414 1.78 1.78 0 0 1 0 2.518 1.78 1.78 0 0 1-2.518 0 1.78 1.78 0 0 1 0-2.518 1.775 1.775 0 0 1 1.905-.445V9.45a1.777 1.777 0 0 1-.892-.477 1.774 1.774 0 0 1-.419-1.783L6.906 4.517.454 10.969a1.488 1.488 0 0 0 0 2.106l10.48 10.48a1.488 1.488 0 0 0 2.106 0l10.506-10.518a1.488 1.488 0 0 0 0-2.107z"
            fill="#F05032"
          />
        </svg>
      );
